...
class HomeViewModel extends BaseViewModel{
  ...
  List<Doctor>getDoctorsForSearchTermOnTab(String? searchTermOnTab){
    if(searchTermOnTab == null){
      return doctors;
    }else return doctors.where((element) => element.doctorProfession.contains(searchTermOnTab)).toList();
  }
